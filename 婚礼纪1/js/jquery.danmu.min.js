...
;(function ($) {
    var Danmu = function (element, options) {
        ...
        this.preTime = 0;
        //最大弹幕数控制
        var maxCount = this.options.maxCountInScreen-1;
        var maxCountPerSec = this.options.maxCountPerSec-1;
        var nowCount = 0;
        var nowSecCount = 0;
        //格式控制
...
//                              });
                    ...
                    //循环
                    if (index == options.sumTime && options.danmuLoop) {
                        me.$timer.timer('stop');
