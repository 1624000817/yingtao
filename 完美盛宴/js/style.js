 var TIME = {
        ...
        So = {
            "comm": {
                "abv": "c",
                "domain": "www.haosou.com",
                "guid": "F665C375D00A4D05AEC63EEBE01F3C62.1420510460624",
                "hasTantan": 1,
                "isWarn": 0,
                "isCtrl": 0,
                "pid": "www",
                ...
                "sug": 1,
                "t": 1440992461984,
                "ssurl": "https:\/\/p.ssl.haosou.com\/p\/",
                "user": {
                    "qid": "",
                    "imageId": "",
                    "showName": ""
                ...
                "monitor": {
                    ...
                    "qt": "77a2bcdb32614861",
                    "rf": "",
                    "sid": "8f8eac4c87d4327dda718b433abdc611",
                    "version": "1.3.3",
                    "cq": "",
                    "tg": 0
                }
...
(function(e, t, n) {
 ...
 _loader.remove && _loader.remove("rili-widget");
                    _loader.add("rili-widget", "./js/wnl.js"); 
                    _loader.use("jquery, rili-widget",
                    function() {
                        ...
                        mediator.subscribe(gMsg.type.actionfestival,
                        function(d) {
                        ...
                        mediator.subscribe(gMsg.type.actionquery,
                        function(d) {
                            var strDate;

                            if (!d.year || d.year > 2019 || d.year < 2017) {
                                RiLi.action = "default";
                                return 0;
                            }
                        ...
                        mediator.subscribe(gMsg.type.actiongoupiao,
                        function(d) {
                            RiLi.action = "goupiao";
                            $wbc.webCalendar({
                                time: dt,
                        ...
                        mediator.subscribe(gMsg.type.actiondefault,
                        function(d) {
                            RiLi.needDay = dt;
                            $wbc.webCalendar({
                                time: dt,
                        ...
                        mediator.subscribe(gMsg.type.dch,
                        function(d) {
